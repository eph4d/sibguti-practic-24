...
@WebMvcTest(ChangeEmailController.class)
public class ChangeEmailControllerTest {
    ...
    @Test
    void changeOtpSend() throws Exception {
        mockMvc.perform(post("/api/v1/userinfo/email/change/otp/send")
    ...
    @Test
    void changeOtpConfirm() throws Exception {
        mockMvc.perform(post("/api/v1/userinfo/email/change/otp/confirm")
                        .contentType(MediaType.APPLICATION_JSON)
